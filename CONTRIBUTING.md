...
6. Update [CHANGELOG.md](https://github.com/Helabs/acts_as_hashed/blob/master/CHANGELOG.md) with a brief description of your changes under the `unreleased` heading.
